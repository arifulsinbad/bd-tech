...
// console.log(updateId._id)
  ...
  return (
    <div className='flex justify-center items-center h-full bg-indigo-200'>
      <form
        className='shadow-lg p-10 rounded-md flex flex-wrap gap-3 max-w-3xl justify-between bg-pink-300'
