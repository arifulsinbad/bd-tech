...
import findProduct from "../Redux/Thunk/findProduct";
            ...
            <tbody class='text-sm divide-y divide-gray-100'>
              {products.map(({ model, brand, price, status, _id }) => (
                <tr>
                  ...
                  <td><Link to='/dashboardLayout/editProduct'><button onClick={()=>dispatch(findProduct(_id))} className="btn btn-xs bg-green-500">Edit</button></Link></td>
                  <td class='p-2'>
